...
write_sf(GSM_centr, "output/sample_centroids.shp", overwrite = TRUE)
```
...
m <- 0.12 # Multiplier applied to block size
...
writeRaster(alrM_aoa$AOA, paste0("output/mud_aoa_", Sys.Date(), ".tif"), overwrite = TRUE)
```
